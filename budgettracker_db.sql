...
alter table bt_category add constraint cat_user_fk
...
alter table bt_transactions add constraint trans_cat_fk
foreign key (category_id) references bt_category(category_id);
alter table bt_transactions add constraint trans_user_fk
foreign key (user_id) references bt_user(user_id);
